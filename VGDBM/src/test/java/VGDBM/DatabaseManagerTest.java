...
public class DatabaseManagerTest {
    ...
    public void insertGame() {
        ...
        try {
            Game game1 = new Game("Testgame", "TestScore", "TestDate", "Testnotes");
            Game game2 = new Game("Testgame2", "TestScore", "2020", "Testnotes2");
            Game game3 = new Game("Testgame3", "5", "TestDate", "Testnotes3");
            ...
            Game game4 = new Game("Testgame4", "5", "2020", "Testnotes4");
            Game game5 = new Game("Testgame5", "-", "2021", "Testnotes5");
            Game game6 = new Game("Testgame6", "5", "-", "Testnotes6");
    ...
    public void updateGame() {
        ...
        try {
            Game game = new Game("Testgame", "5", "2020", "Testnotes");
            db.insertGame(game);
            Game updatedGame = new Game("Updategame", "0", "2021", "Testnotes2");
    ...
    public void removeGame() {
        ...
        try {
            Game game = new Game("Deletedgame", "5", "2020", "Testnotes");
            db.insertGame(game);
