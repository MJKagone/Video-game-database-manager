...
public class DatabaseManagerTest {
    ...
    public void insertGame() {
        ...
        try {
            Game game1 = new Game("Testgame", "TestScore", "TestDate", "TestPlatform", "TestGenre", "Testnotes");
            Game game2 = new Game("Testgame2", "TestScore", "2020", "TestPlatform", "TestGenre", "Testnotes2");
            Game game3 = new Game("Testgame3", "5", "TestDate", "TestPlatform", "TestGenre", "Testnotes3");
            ...
            Game game4 = new Game("Testgame4", "5", "2020", "TestPlatform", "TestGenre", "Testnotes4");
            Game game5 = new Game("Testgame5", "-", "2021", "PS5", "Action", "Testnotes5");
            Game game6 = new Game("Testgame6", "5", "-", "TestPlatform", "Action|Adventure", "Testnotes6");
    ...
    public void updateGame() {
        ...
        try {
            Game game = new Game("Testgame", "5", "2020", "Testplatform", "TestGenre", "Testnotes");
            db.insertGame(game);
            Game updatedGame = new Game("Updategame", "0", "2021", "Switch", "Action|Adventure", "Testnotes2");
    ...
    public void removeGame() {
        ...
        try {
            Game game = new Game("Deletedgame", "5", "2020", "Testplatform", "TestGenres", "Testnotes");
            db.insertGame(game);
