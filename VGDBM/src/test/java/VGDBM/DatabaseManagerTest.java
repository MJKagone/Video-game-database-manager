...
public class DatabaseManagerTest {
    ...
    public void insertGame() {
        ...
        try {
            Game game1 = new Game("Testgame", "TestScore", "TestDate", "TestGenre", "TestPlatform", "Testnotes");
            Game game2 = new Game("Testgame2", "TestScore", "2020", "TestGenre", "TestPlatform", "Testnotes2");
            Game game3 = new Game("Testgame3", "5", "TestDate", "TestGenre", "TestPlatform", "Testnotes3");
            ...
            Game game4 = new Game("Testgame4", "5", "2020", "TestGenre", "TestPlatform", "Testnotes4");
            Game game5 = new Game("Testgame5", "-", "2021", "Action", "PS5", "Testnotes5");
            Game game6 = new Game("Testgame6", "5", "-", "Action|Adventure", "TestPlatform", "Testnotes6");
            ...
            assertTrue(insertedGame4.getGenres().equals("TestGenre"));
            ...
            assertTrue(insertedGame5.getGenres().equals("Action"));
            ...
            assertTrue(insertedGame6.getGenres().equals("Action|Adventure"));
            ...
            assertTrue(insertedGame7.getGenres().equals("-"));
    ...
    public void updateGame() {
        ...
        try {
            Game game = new Game("Testgame", "5", "2020", "TestGenre", "Testplatform", "Testnotes");
            db.insertGame(game);
            Game updatedGame = new Game("Updategame", "0", "2021", "Action|Adventure", "Switch", "Testnotes2");
            ...
            assertTrue(insertedGame.getGenres().equals("Action|Adventure"));
    ...
    public void removeGame() {
        ...
        try {
            Game game = new Game("Deletedgame", "5", "2020", "TestGenres", "Testplatform", "Testnotes");
            db.insertGame(game);
